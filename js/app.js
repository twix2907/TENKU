...
if (navigator.userAgent.includes("Android")) {
    ...
    window.addEventListener("beforeinstallprompt", e => {
        ...
        mostrarBotonInstalar(); // Mostrando el botón de instalación
    });
}
// Función para mostrar el botón de instalación
function mostrarBotonInstalar() {
    const instalarbtn = document.getElementById('install-button');
    instalarbtn.style.display = 'block'; // Mostrando el botón de instalación

    // Evento para hacer clic en el botón de instalación
    instalarbtn.addEventListener('click', e => {
...
document.getElementById('confirm-zone-btn').addEventListener('click', function () {
    ...
    addZona(center.lat, center.lng, radius);
